...
export class NearExpiry98cStrategy implements StrategyPlugin {
  readonly id = "NearExpiry98c";
  ...
  decide(input: StrategyInput): StrategyAction {
    ...
    return { action: "BUY", side: d.side, price: d.limitPrice, sizeUsd: d.usdSize, reason: d.reason };
  }
}
